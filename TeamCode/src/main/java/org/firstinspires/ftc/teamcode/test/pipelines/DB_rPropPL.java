package org.firstinspires.ftc.teamcode.test.pipelines;
...
public class DB_rPropPL extends OpenCvPipeline {
    ...
    static final Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(225,200);
    static final Point REGION3_TOPLEFT_ANCHOR_POINT = new Point(540,175);
    ...
    Point region1_pointB = new Point(
            REGION1_TOPLEFT_ANCHOR_POINT.x + 25,
            REGION1_TOPLEFT_ANCHOR_POINT.y + 150);
    Point region2_pointA = new Point(
            REGION2_TOPLEFT_ANCHOR_POINT.x,
            REGION2_TOPLEFT_ANCHOR_POINT.y);
    Point region2_pointB = new Point(
            REGION2_TOPLEFT_ANCHOR_POINT.x + 150,
    ...
    public Mat processFrame(Mat input) {
        ...
        if (max > 150) {
            ...
            if (max == avg2) // Was it from region 1?
            {
            ...
            else if (max == avg3) // Was it from region 2?
            {
